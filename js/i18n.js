...
const i18nMessages = Object.freeze({
    en: {
        ...
        "devlog.metaDescription": "A retrospective development log of DARIO.exe from the first commit through version 1.4, based on the documented project history.",
        "devlog.title": "DEVLOG | DARIO.exe",
        "devlog.kicker": "> VERSION HISTORY",
        "devlog.heading": "DEVLOG",
        "devlog.intro": "From the first commit through v1.4: the documented milestones, challenges and lessons behind DARIO.exe.",
    ...
    de: {
        ...
        "devlog.metaDescription": "Ein rückblickender Entwicklungsbericht zu DARIO.exe vom ersten Commit bis Version 1.4, basierend auf der dokumentierten Projektgeschichte.",
        "devlog.title": "DEVLOG | DARIO.exe",
        "devlog.kicker": "> VERSIONSGESCHICHTE",
        "devlog.heading": "DEVLOG",
        "devlog.intro": "Vom ersten Commit bis v1.4: die dokumentierten Meilensteine, Herausforderungen und Learnings hinter DARIO.exe.",
